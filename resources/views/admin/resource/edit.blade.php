                                ...
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.resource.update' , $resource->id) }}" class="edit-form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <textarea type="text" name="content" id="resource-content" rows="5" class="form-control @error('content') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Type Resource Content..." autocomplete="nope" >{{ $resource->content }}</textarea>
                                            @error('content')
                                                <small class="form-text text-danger">{{$message }}</small>
                                            @enderror
                                        </div>
